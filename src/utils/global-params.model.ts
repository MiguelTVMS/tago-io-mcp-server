...
const genericIDSchema = z.object({
  id: z
    ...
    .describe('ID used on TagoIO, string with 24 characters')
...
const querySchema = z.object({
  ...
  amount: z
    ...
    .min(1)
    .max(10000)
    .describe('Amount of items will return (max: 10000, min: 1)')
    .optional(),
  fields: z
    .array(z.string())
  ...
  filter: z
    ...
    .describe("Filter object to apply to the query. E.g: { name: 'John' }")
    .optional(),
