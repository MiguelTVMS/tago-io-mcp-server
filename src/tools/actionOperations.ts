    ...
    z
        .object({
            resource: z
                ...
                .describe('The resource to monitor'),
    ...
    z
        .object({
            ...
            value_type: z
                ...
                .describe('The type of value being compared'),
...
- "usage_alert": Monitors account usage metrics against thresholds for services like input/output data, analysis minutes, SMS, email, push notifications, file storage, and resource counts
  - Usage alert triggers must specify the monitored resource (input, output, analysis, data_records, sms, email, run_users, push_notification, file_storage, device, dashboard, action, tcore, team_members, am) and threshold values.`),
        action: z
            .object({
                ...
                script: z
                    .array(z.string())
                    .describe(
                        'Here you put the analysis ID that should be executed. Required for actions with type script.'
                    )
                    .optional(),
                message: z
                    .string()
                ...
                subject: z
                    .string()
                    .describe(
                        'The subject of the email or notification to be sent. Required for actions with type email, notification, notification_run, email-sendgrid, email-smtp.'
                    )
                    .optional(),
                run_user: z
                    .string()
                    .describe(
                        'The run_user ID of the user that will receive the notification. Required for actions with type notification_run.'
                    )
                    .optional(),
                to: z
                    .string()
                    .describe(
                        'The phone number or email address to send the message to. Required for actions with type email, sms, sms-twilio, whatsapp-twilio, email-sendgrid, email-smtp.'
                    )
                    .optional(),
                from: z
                    .string()
                ...
                bucket: z
                    .string()
                    .describe(
                        'The device ID to receive MQTT published message. Required for actions with type mqtt.'
                    )
                    .optional(),
                payload: z
                    .string()
                    .describe(
                        'The message that will be published to the MQTT topic. Required for actions with type mqtt.'
                    )
                    .optional(),
                topic: z
                    .string()
                    .describe('The topic of the MQTT message. Required for actions with type mqtt.')
                    .optional(),
                url: z
                    .string()
                    .describe('The url of the post request. Required for actions with type post.')
                    .optional(),
                headers: z
                    .record(z.string(), z.string())
                    .describe('The headers of the post request. Required for actions with type post.')
                    .optional(),
                twilio_sid: z
                    .string()
                    .describe(
                        'The ID of the secret that contains the Twilio SID. Required for actions with type sms-twilio, whatsapp-twilio.'
                    )
                    .optional(),
                twilio_token: z
                    .string()
                    .describe(
                        'The ID of the secret that contains the Twilio token. Required for actions with type sms-twilio, whatsapp-twilio.'
                    )
                    .optional(),
                content_variables: z
                    .array(
                    ...
                    .describe(
                        'The variables to be sent to the Twilio WhatsApp message template. Optional for actions with type whatsapp-twilio.'
                    )
                    .optional(),
                content_sid: z
                    .string()
                    .describe(
                        'The ID of the secret that contains the WhatsApp message template. Required for actions with type whatsapp-twilio.'
                    )
                    .optional(),
                sendgrid_api_key: z
                    .string()
                    .describe(
                        'The ID of the secret that contains the Sendgrid API key. Required for actions with type email-sendgrid.'
                    )
                    .optional(),
                smtp_secret: z
                    .string()
                    .describe(
                        'The ID of the secret that contains the SMTP secret. Required for actions with type email-smtp.'
                    )
                    .optional(),
                sqs_secret: z
                    .string()
                    .describe(
                        'The ID of the secret that contains the SQS secret. Required for actions with type queue-sqs.'
                    )
                    .optional(),
                batch_enabled: z
                    .boolean()
                    .describe(
                        'Whether the SQS queue is batch enabled. Required for actions with type queue-sqs.'
                    )
                    .optional(),
            })
        ...
        tags: z
            ...
            .describe("The tags for the action. E.g: [{ key: 'action_type', value: 'notification' }]")
            .optional(),
...
const actionListSchema = querySchema
    .extend({
        ...
        `
                ...
                tags: z
                    .array(tagsObjectModel)
                    .describe("Filter by tags. E.g: [{ key: 'action_type', value: 'notification' }]")
                    .optional(),
            ...
            .describe(
                'Filter object to apply to the query. Available filters: name, active, last_triggered, created_at, updated_at, tags'
            )
            .optional(),
    })
    .describe('Schema for the action list operation.');

const actionUpdateSchema = actionCreateSchema
    .partial()
...
const actionBaseSchema = z
    .object({
        operation: z
            .enum(['create', 'update', 'delete', 'lookup'])
            .describe('The type of operation to perform on the action.'),
        actionID: z
            .string()
            .describe(
                'The ID of the action to perform the operation on. Optional for lookup and create, but required for update and delete operations.'
            )
            .optional(),
        createAction: actionCreateSchema
            .describe('The action to be created. Required for create operations.')
            .optional(),
        lookupAction: actionListSchema
            .describe('The action to be listed. Required for lookup operations.')
            .optional(),
        updateAction: actionUpdateSchema
            .describe('The action to be updated. Required for update operations.')
            .optional(),
    })
...
const actionSchema = actionBaseSchema.refine(
    ...
    {
        message:
            'Invalid data structure for the specified operation. Create requires createAction, update requires updateAction.',
    }
);
