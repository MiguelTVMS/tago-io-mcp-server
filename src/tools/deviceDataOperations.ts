...
/**
 * @description Array of all device data tool configurations.
 */
const deviceDataTools: IDeviceToolConfig[] = [deviceDataOperationsConfig];
...
export { deviceDataBaseSchema }; // export for testing purposes
