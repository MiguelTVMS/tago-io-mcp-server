    ...
    filter: z
      .object({
        ...
        tags: z
          ...
          .describe("Filter by tags. E.g: [{ key: 'device_type', value: 'sensor' }]")
          .optional(),
...
const deviceCreateSchema = z
  ...
  `
    ...
    tags: z
      ...
      .describe("The tags for the device. E.g: [{ key: 'device_type', value: 'sensor' }]")
      .optional(),
    description: z.string().describe('The description of the device.').optional(),
    active: z
      .boolean()
      .describe('The active status of the device. When not given, the active status will be true.')
      .optional(),
    configuration_params: z
      .array(configParamSchema)
      .describe(
...
const deviceBaseSchema = z
  ...
  `),
    ...
    configureDevice: deviceConfigureSchema
      .describe('The configuration parameters to set/update. Required for configure operations.')
      .optional(),
  })
...
async function handleLookupOperation(resources: Resources, params: DeviceSchema): Promise<string> {
  ...
  if (
    devices.length !== 1 &&
    (lookupDevice?.include_data_amount || lookupDevice?.include_configuration_params)
  ) {
