...
import { analysisBaseSchema } from '../../../../src/services/analysis/tools/analysis-operations.js';
...
describe('analysisBaseSchema validation', () => {
  ...
  describe('lookupAnalysis validation', () => {
    ...
    it('should validate runtime enum values', () => {
      const validData = {
        operation: 'lookup' as const,
        lookupAnalysis: { filter: { runtime: 'node' as const } },
      };
      const invalidData = {
        operation: 'lookup' as const,
        lookupAnalysis: { filter: { runtime: 'java' } },
      };
    ...
    it('should validate run_on enum values', () => {
      const validData = {
        operation: 'lookup' as const,
        lookupAnalysis: { filter: { run_on: 'tago' as const } },
      };
      const invalidData = {
        operation: 'lookup' as const,
        lookupAnalysis: { filter: { run_on: 'cloud' } },
      };
